...
class CreateInmueblesPlanosTable extends Migration {
	...
	public function up()
	{
		Schema::create('inmuebles_planos', function(Blueprint $table)
		{
			$table->integer('id_inmuebles_planos', true);
