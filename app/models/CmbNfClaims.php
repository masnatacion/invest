...
class CmbNfClaims extends \Crud {


    protected $primaryKey = 'id_cmb_nf_claims'; // !important

    protected $table = 'cmb_nf_claims';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_nf_claims','id_pcustomer','id_awb','date','status'],
        "show"      => [],
