...
class Invoice extends \Crud {
    ...
    protected $primaryKey = 'id_invoice'; // !important
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_invoice','id_pcustomer','date', 'total'],
        "show"      => [],
    ...
    public function awbs($id,$record)
    {
        $table     = "invoice_awb";
        $arguments = [
            "index"        => ["id_invoice_awb","id_awb","amount"]
        ];
        $where = ["where" => ["id_invoice"=>$id]];
