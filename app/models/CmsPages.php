...
class CmsPages extends \Crud {


    protected $primaryKey = 'id_cms_pages'; // !important
    ...
    protected $crud = [
        ...
        "inputs"    => ["html_body1"=>"html","html_body2"=>"html","html_body3"=>"html","html_body4"=>"html","status"=>"radiogroup"],
        // 
        ...
        //    
        "joins"      => ["images1" => ["cms_images","id_cms_images"]],            
        // 
        // Tabs
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cms_pages','title','alias','status'],
        "show"      => [],
