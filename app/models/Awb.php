...
class Awb extends \Crud {


    protected $primaryKey = 'id_awb'; // !important
    ...
    protected $crud = [
        ...
        // 
        "labels"    => ['to_id_customer'=>'To Customer','from_id_customer'=>'From Customer'],
        //
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_awb','from_id_customer','to_id_customer','origin','destination'],
        "show"      => [],
    ...
    public function pobox($id,$record)
    {
        ...
        return \View::make("admin.awb.tabs.pobox")
