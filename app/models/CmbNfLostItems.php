...
class CmbNfLostItems extends \Crud {


    protected $primaryKey = 'id_cmb_nf_lost_items'; // !important

    protected $table = 'cmb_nf_lost_items';
    ...
    protected $crud = [
        ...
        //
        "inputs"    => ["comments"=>"editor","status"=>"radiogroup"],
        // 
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_nf_lost_items','id_pcustomer','date','shipper_name','consignee','tracking'],
        "show"      => [],
	...
	public function pobox($id,$record)
    {
        $table     = "pobox_items";
        $arguments = [
            "index"        => ["id_pobox","item_description","weight","wunit","declared_value"]
        ];
        $where = ["where" => ["tracking"=>$record->tracking]];
