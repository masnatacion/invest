...
class Manifest extends \Crud {


    protected $primaryKey = 'id_manifest'; // !important
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_manifest','id_agency','date','origin','destination'],
        "show"      => [],
    ...
    public function awb($id,$record)
    {
			...
			return \View::make("admin.payments.tabs.lines")
