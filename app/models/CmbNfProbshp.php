...
class CmbNfProbshp extends \Crud {


    protected $primaryKey = 'id_cmb_nf_probshp'; // !important

    protected $table = 'cmb_nf_probshp';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_nf_probshp','id_pcustomer','problem_date','tracking','status'],
        "show"      => [],
