...
class CmbNfShop extends \Crud {


    protected $primaryKey = 'id_cmb_nf_shop'; // !important

    protected $table = 'cmb_nf_shop';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_nf_shop','id_pcustomer','itemname','date','status'],
        "show"      => [],
