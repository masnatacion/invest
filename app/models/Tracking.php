...
class Tracking extends \Crud {
    ...
    protected $primaryKey = 'id_tracking'; // !important
    ...
    public function probshp($id,$record)
    {
        ...
        $arguments = [
            "index"        => ["problem_date","carrier","tracking","status"]
        ];
    ...
    public function shop($id,$record)
    {
        $table     = "cmb_nf_shop";
        $arguments = [
            "index"        => ["company_name","itemname","item","price","status"]
        ];
        $where = [
                    "where" => [
                                    "tracking"  => $id,
        ...
        //id_cmb_nf_shop, date, origin, destination , pieces, weight (+ unit)
