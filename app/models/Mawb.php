...
class Mawb extends \Crud {


    protected $primaryKey = 'id_mawb'; // !important
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_mawb','executedon','airport_of_departure','airport_of_destination', 'issuedby','total_num_of_pieces','total_gross_weight'],
        "show"      => [],
