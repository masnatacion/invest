...
class CmbNfShpinst extends \Crud {


    protected $primaryKey = 'id_cmb_nf_shpinst'; // !important

    protected $table = 'cmb_nf_shpinst';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_nf_shpinst','id_pcustomer','shippers_name','pickup_company','date','status'],
        "show"      => [],
    ...
    public function tracking($id,$record)
    {
        $table     = "cmb_nf_shpinst_tracking";
        $arguments = [
            "index"        => ["id_cmb_nf_shpinst_tracking","carrier","tracking"]
        ];
        $where = ["where" => ["id_cmb_nf_shpinst"=>$id]];
