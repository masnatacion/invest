...
class CmbCrmtickets extends \Crud {


    protected $primaryKey = 'id_cmb_crmtickets'; // !important

    protected $table = 'cmb_crmtickets';
    ...
    protected $crud = [
        ...
        // 
        "labels"    => ['id_pcustomer'=>'Customer','ownerid'=>'Ticket Owner','lastupdate'=>'Last Update'],
        //
    ...
    function same_custumer($id)
    {

        $table     = "cmb_crmtickets";
        $arguments = [
            "not_in_index" => ["id_pcustomer","solution_datetime","lastupdate","body","updated_by","updated_at","ownerid"],
            "fk_column"    => ["created_by"  => ["id_users","first_name","last_name"]],
        ];
        $where = ["where" => ["id_pcustomer"=>$id]];
        //id_cmb_crmtickets, created_at, subject, priority, ownerid (+ name), status
