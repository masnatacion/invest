...
class Blading extends \Crud {


    protected $primaryKey = 'id_blading'; // !important

    protected $table = 'blading';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_blanding','doc_number','port_of_loading','port_of_discharge','declared_value'],
        "show"      => [],
