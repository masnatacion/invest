...
class CmbInvitation extends \Crud {


    protected $primaryKey = 'id_cmb_invitation'; // !important

    protected $table = 'cmb_invitation';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_invitation','id_pcustomer','email','status'],
        "show"      => [],
