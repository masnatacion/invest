...
class TrackingCarrier extends \Crud {


    protected $primaryKey = 'id_tracking_carrier'; // !important

    protected $table = 'tracking_carrier';
    ...
    protected $crud = [
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_tracking_carrier','name','status'],
        "show"      => [],
