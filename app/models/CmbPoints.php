...
class CmbPoints extends \Crud {


    protected $primaryKey = 'id_cmb_points'; // !important

    protected $table = 'cmb_points';
    ...
    protected $crud = [
        ...
        // 
        "labels"    => ['id_pcustomer'=>'Customer','id_cmb_invitation'=>'Invitation','id_awb'=>'AWB'],
        //
        ...
        "create"    => [],
        "edit"      => [],
        "index"     => ['id_cmb_points','id_pcustomer','id_awb','message','points','status'],
        "show"      => [],
