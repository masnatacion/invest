function ModalAjax($click,callback)
{
	...
	$($click).click(function(event){
        ...
        $.ajax({
            ...
            processData : false,
            beforeSend  : function(){
                modal.html("<div class='padding-md'><img src='./img/loading.gif'/></div>"); 
            }
        }).done(function(data){
        	modal.html(data);
...
$( document ).ready(function() {
	...
	$(".form-search-toolbar .select2-container").css("width","8em");
	// $(".select2-selection--single").addClass("btn-default");
